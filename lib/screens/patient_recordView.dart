...
import 'package:flutter_application_1/screens/server_stub.dart';
import 'package:flutter_application_1/screens/stripe_checkout_stub.dart';
...
class RecordPatienViewtScreen extends StatefulWidget { //ProfilesDoctorScreen
final String id;
final String dname;
final String date;
final String time;
  ...
  const RecordPatienViewtScreen({Key? key,required this.id, required this.dname, required this.date, required this.time, }) : super(key: key);


  @override
  _RecordPatienViewtScreenState createState() => _RecordPatienViewtScreenState();
}



class _RecordPatienViewtScreenState extends State<RecordPatienViewtScreen> {
